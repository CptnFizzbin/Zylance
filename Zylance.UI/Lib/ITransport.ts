...
function isDesktopExternal(obj: unknown): obj is DesktopExternal {
  return (
    typeof obj === "object" &&
    obj !== null &&
    "sendMessage" in obj &&
    typeof obj.sendMessage === "function" &&
    "receiveMessage" in obj &&
    typeof obj.receiveMessage === "function"
  )
}
...
export function getTransport(): ITransport {
  ...
  if (isDesktopExternal(external)) {
    return {
      ...
      receive: (handler: (message: string) => void) =>
