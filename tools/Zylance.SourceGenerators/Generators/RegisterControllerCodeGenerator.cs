...
internal static class RegisterControllerCodeGenerator
{
    ...
    private static string Generate(ControllerInfo controller)
    {
        ...
        return $$"""
                 ...
                 {
                    /// <summary>
                    /// Registers handlers from {{controllerClassName}} onto the RouterService.
                    /// </summary>
                    /// <param name="router">Router to register handlers onto.</param>
                    /// <param name="controller">Controller instance whose handlers should be registered.</param>
                             ...
                             $$"""
                               {
                                   ...
                                   Log.Information($"[RouterService] Registering event handler '{eventName}': {{controller.ClassType.Name}}.{{handler.Method.Name}}");
