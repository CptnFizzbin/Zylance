...
{
    private static readonly DiagnosticDescriptor MissingControllerAttribute = new(
        "ZYL001",
    ...
    private static readonly DiagnosticDescriptor InvalidRequestHandlerSignature = new(
        "ZYL002",
    ...
    private static readonly DiagnosticDescriptor InvalidEventHandlerSignature = new(
        "ZYL003",
        "Invalid handler method signature",
    ...
    private static readonly DiagnosticDescriptor RequestHandlerTypeMismatch = new(
        "ZYL004",
    ...
    {
        return Diagnostic.Create(MissingControllerAttribute, classSymbol.Locations.First(), classSymbol.Name);
    }
    ...
    {
        return Diagnostic.Create(InvalidRequestHandlerSignature, method.Locations.First(), method.Name);
    }
    ...
    {
        return Diagnostic.Create(InvalidEventHandlerSignature, method.Locations.First(), method.Name);
    }
    ...
    {
        return Diagnostic.Create(RequestHandlerTypeMismatch, method.Locations.First(), method.Name);
    }
}
