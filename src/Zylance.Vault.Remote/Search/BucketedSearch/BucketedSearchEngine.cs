    ...
    where TItemId : notnull
{
    ...
    /// <param name="content">Plaintext content to tokenize and index.</param>
    ...
    /// </summary>
    /// <param name="items">Tuples of item IDs and their plaintext content to index.</param>
    ...
    /// <summary>
    /// Updates an indexed item's content by reindexing changed tokens.
    /// </summary>
    /// <param name="itemId">The item identifier to update.</param>
    /// <param name="oldContent">The previous plaintext content.</param>
    /// <param name="content">The new plaintext content to index.</param>
    ...
    /// <summary>
    /// Updates multiple items' indexed content in a batch operation using differential reindexing.
    /// </summary>
    /// <param name="items">List of tuples containing (itemId, oldContent, newContent).</param>
    ...
    /// <summary>
    /// Removes an item from the index by deleting its tokens from keyword buckets.
    /// </summary>
    /// <param name="itemId">The item identifier to remove.</param>
    /// <param name="content">The plaintext content that was indexed.</param>
    ...
    /// <summary>
    /// Removes multiple items from the index in a batch operation.
    /// </summary>
    /// <param name="items">List of tuples (itemId, content) to remove from the index.</param>
    ...
    /// <summary>
    /// Searches for items matching all space-separated search terms (AND semantics).
    /// </summary>
    /// <param name="terms">Space-separated search terms.</param>
    /// <param name="direction">The direction to traverse buckets; latest-first by default.</param>
    /// <param name="fuzzy">If true, performs substring matching; otherwise exact token matching.</param>
