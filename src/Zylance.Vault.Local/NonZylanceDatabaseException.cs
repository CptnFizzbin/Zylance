...
public class NonZylanceDatabaseException : Exception
{
    ...
    /// <summary>
    /// Creates an exception for non-Zylance database errors with an inner exception.
    /// </summary>
    /// <param name="filePath">Path to the database file.</param>
    /// <param name="reason">Explanation for the error.</param>
    ...
    /// <summary>
    /// Helper to create an exception indicating the file is invalid or not a SQLite DB.
    /// </summary>
    ...
    /// <summary>
    /// Helper to create an exception indicating the file is invalid, preserving the inner exception.
    /// </summary>
