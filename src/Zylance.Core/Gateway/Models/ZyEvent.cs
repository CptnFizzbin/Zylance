...
/// <summary>
///     Represents an event received from the gateway, containing a payload and
///     helpers to deserialize the event data.
/// </summary>
public class ZyEvent
{
    ...
    /// <summary>
    ///     Deserializes the event payload data into a protobuf message of type
    ...
    /// <summary>
    ///     Attempts to deserialize the event payload into
...
/// <summary>
///     Strongly-typed event wrapper for events with payload data of type
///     <typeparamref name="TData" />.
/// </summary>
...
{
    /// <summary>
    ///     Strongly-typed access to the event data of type
    ///     <typeparamref name="TData" />.
    /// </summary>
