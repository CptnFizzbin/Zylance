...
/// <summary>
/// Represents a request message received via the gateway along with helpers to access typed payload data.
/// </summary>
public class ZyRequest
{
    ...
    /// <summary>
    /// Deserializes the request payload data into a protobuf message of type <typeparamref name="TData"/>.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to deserialize the request payload into <typeparamref name="TData"/>, returning true on success.
    /// </summary>
...
/// <summary>
/// Strongly-typed request wrapper for requests carrying data of type <typeparamref name="TData"/>.
/// </summary>
