...
/// <summary>
/// Represents a response message sent via the gateway with helpers to set and get typed data.
/// </summary>
public class ZyResponse
{
    ...
    /// <summary>
    /// Deserializes the response payload data into a protobuf message of type <typeparamref name="TData"/>.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to deserialize the response payload into <typeparamref name="TData"/>, returning true on success.
    /// </summary>
...
/// <summary>
/// Strongly-typed response wrapper for responses carrying data of type <typeparamref name="TData"/>.
/// </summary>
    ...
    where TData : IMessage, new()
{
    ...
    /// <summary>
    /// Attempts to get the strongly-typed response data, returning true on success.
    /// </summary>
