...
/// <summary>
/// Lightweight routing service used by the gateway to map actions and event names to handler delegates.
/// Generated registration code calls into this service to register controllers.
/// </summary>
