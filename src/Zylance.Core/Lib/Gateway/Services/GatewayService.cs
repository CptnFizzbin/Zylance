...
public class GatewayService
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="GatewayService"/> with the specified transport and router.
    /// </summary>
    ...
    /// <summary>
    /// Subscribes the given handler to events with the specified name and returns a subscription that can be disposed.
    /// </summary>
