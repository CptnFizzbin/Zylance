...
/// <summary>
/// Helper methods for serializing and deserializing gateway payloads to/from JSON.
/// </summary>
public static class MessageUtils
{
    ...
    /// <summary>
    /// Deserializes a JSON message into a protobuf message instance of type <typeparamref name="TData"/>.
    /// </summary>
    ...
    /// <summary>
    /// Returns true if the envelope contains an event whose name starts with the provided prefix.
    /// </summary>
    ...
    /// <summary>
    /// Creates a RequestPayload for the specified data using the protobuf action option.
    /// </summary>
    ...
    /// <summary>
    /// Creates an EventPayload from a protobuf message using its event name option.
    /// </summary>
