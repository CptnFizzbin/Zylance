...
/// <summary>
/// Provides file selection and manipulation operations used by the application.
/// </summary>
public interface IFileProvider
{
    ...
    /// <summary>
    /// Updates the last-access time for the given file reference (platform-specific).
    /// </summary>
