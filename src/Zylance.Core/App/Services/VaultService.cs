...
/// <summary>
/// Application-level service that coordinates opening, creating, and closing the active vault.
...
)
{
    ...
    /// <summary>
    /// Returns a reference to the currently active vault, or null if none is active.
    /// </summary>
