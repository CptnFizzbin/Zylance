...
{
    /// <summary>
    /// Selects a file using the platform file provider and returns the selected file reference.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new file using the platform file provider and returns the created file reference.
    /// </summary>
